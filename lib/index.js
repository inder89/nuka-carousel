...
function (_React$Component) {
  ...
  _createClass(Carousel, [{
    ...
    value: function render() {
      ...
      var validChildren = (0, _bootstrappingUtilities.addAccessibility)((0, _bootstrappingUtilities.getValidChildren)(this.props.children), slidesToShow, currentSlide);
      var transitionProps = (0, _styleUtilities.getTransitionProps)(this.props, this.state);
      return _react.default.createElement("div", {
        ...
        children: function children(_ref2) {
          var tx = _ref2.tx,
              ty = _ref2.ty;
          return _react.default.createElement(TransitionControl, _extends({}, transitionProps, {
            deltaX: tx,
            deltaY: ty
          }), validChildren);
        }
